...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$npm','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$fakultas','$prodi','$email','$gambar','$alamat')";
...
function hapus($npm)
{
    ...
    mysqli_query($koneksi, "DELETE FROM siswa WHERE npm = $npm");
    return mysqli_affected_rows($koneksi);
}
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', fakultas = '$fakultas', prodi = '$prodi', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE npm = $npm";
