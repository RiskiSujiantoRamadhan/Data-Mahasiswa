...
$siswa = query("SELECT * FROM siswa ORDER BY npm DESC");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <table id="data" class="table table-striped table-responsive table-hover text-center"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['prodi']; ?></td>
                            <td>
                                <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['npm']; ?>"
                                    style="font-weight: 600;"><i
                                        class="bi bi-info-circle-fill"></i>&nbsp;Detail</button> |

                                <a href="ubah.php?npm=<?= $row['npm']; ?>" class="btn btn-warning btn-sm"
                                    style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                <a href="hapus.php?npm=<?= $row['npm']; ?>" class="btn btn-danger btn-sm"
