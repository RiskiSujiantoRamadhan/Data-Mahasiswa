...
$siswa = query("SELECT * FROM siswa WHERE npm = $npm")[0];
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="npm" value="<?= $siswa['npm']; ?>" name="npm"
                            readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="fakultas" name="fakultas">
                            ...
                            <option value="Teknik" <?php if ($siswa['fakultas'] == 'Teknik') { ?> selected=''
                                <?php } ?>>
                                Teknik</option>
                            <option value="Hukum" <?php if ($siswa['fakultas'] == 'Hukum') { ?> selected='' <?php } ?>>
                                Hukum</option>
                            <option value="Pertanian" <?php if ($siswa['fakultas'] == 'Pertanian') { ?> selected=''
                                <?php } ?>>
                                Pertanian</option>
                            <option value="Kedokteran" <?php if ($siswa['fakultas'] == 'Kedokteran') { ?> selected=''
                                <?php } ?>>
                                Kedokteran</option>
                            <option value="Ekonomi dan Bisnis"
                                <?php if ($siswa['fakultas'] == 'Ekonomi dan Bisnis') { ?> selected='' <?php } ?>>
                                Ekonomi dan Bisnis</option>
                            <option value="Ilmu Sosial dan Ilmu Politik"
                                <?php if ($siswa['fakultas'] == 'Ilmu Sosial dan Ilmu Politik') { ?> selected=''
                                <?php } ?>>
                                Ilmu Sosial dan Ilmu Politik</option>
                            <option value="Keguruan dan Ilmu Pendidikan"
                                <?php if ($siswa['fakultas'] == 'Keguruan dan Ilmu Pendidikan') { ?> selected=''
                                <?php } ?>>
                                Keguruan dan Ilmu Pendidikan</option>
                            <option value="Matematika dan Ilmu Pengetahuan Alam"
                                <?php if ($siswa['fakultas'] == 'Matematika dan Ilmu Pengetahuan Alam') { ?> selected=''
                                <?php } ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control w-50" id="prodi" value="<?= $siswa['prodi']; ?>"
